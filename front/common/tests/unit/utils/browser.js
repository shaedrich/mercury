QUnit.module('mercury/utils/browser', function (hooks) {
	...
	QUnit.test('detection of mobile operating system', function () {
		var testCases = [
			{
				userAgent: 'Mozilla/5.0 (iPhone; CPU iPhone OS 7_0 like Mac OS X; en-us) AppleWebKit/537.51.1' +
			...
			{
				userAgent: 'Mozilla/5.0 (compatible; MSIE 10.0; Windows Phone 8.0; Trident/6.0; IEMobile/10.0;' +
				' ARM; Touch; NOKIA; Lumia 820)',
				expectedOutput: null
			}
		];

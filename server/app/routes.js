...
function sassHandler(request, reply) {
	...
	sass.render({
		// TODO extract it
		data: `$color-page: ${request.query['color-page']};$color-links: ${request.query['color-links']};$color-buttons: ${request.query['color-buttons']}; @import '/usr/wikia/mercury/current/front/main/app/styles/app-runtime.scss';`,
